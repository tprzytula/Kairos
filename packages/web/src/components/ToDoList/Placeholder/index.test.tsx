...
describe('Given the Placeholder component', () => {
  describe('When rendering with default props', () => {
    it('should display the to-do placeholders container', () => {
      render(<Placeholder />);
  ...
  describe('When rendering with custom numberOfGroups', () => {
    it('should render the specified number of groups', () => {
      ...
      expect(screen.getAllByLabelText('To do item placeholder')).toHaveLength(12);
    });
    ...
    it('should still display the placeholders container', () => {
      ...
      expect(screen.getByLabelText('Loading to-do items')).toBeInTheDocument();
      expect(screen.getAllByLabelText('To do item placeholder')).toHaveLength(7);
    });
  });
  ...
  describe('When rendering with zero groups', () => {
    it('should render without errors', () => {
      ...
      expect(screen.getByLabelText('Loading to-do items')).toBeInTheDocument();
      expect(screen.queryAllByLabelText('To do item placeholder')).toHaveLength(0);
    });
  });
});
