...
export const DateGroupPlaceholder = styled('div')({
  marginBottom: '2px',
})

export const DateHeaderPlaceholder = styled('div')(({ theme }) => ({
  fontSize: '12px',
  fontWeight: 700,
  color: theme.palette.text.secondary,
  textTransform: 'uppercase',
...
export const DateHeaderContentPlaceholder = styled('div')({
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'space-between',
  flex: 1,
...
export const DateLabelPlaceholder = styled('div')({
  width: '120px',
  height: '12px',
  borderRadius: '4px',
  display: 'block',
...
export const ItemCountPlaceholder = styled('div')({
  width: '30px',
  height: '11px',
  borderRadius: '4px',
  display: 'block',
...
export const StatsContainerPlaceholder = styled('div')({
  display: 'flex',
  alignItems: 'center',
  gap: '12px',
})
...
export const ExpandIconPlaceholder = styled('div')({
  width: '20px',
  height: '20px',
  borderRadius: '4px',
  opacity: 0.3,
